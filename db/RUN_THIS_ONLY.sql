...
-- ============================================================================
-- 018: 누락 근거 논문 추가 (Grade A/B 핵심 효능 보강)
-- ============================================================================

-- 비타민 D → BONE_HEALTH (PMID 41470812)
...
-- 비타민 C → ANTIOXIDANT (PMID 32162041)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
  sample_size, population_text, duration_text,
...
-- 오메가-3 → BLOOD_LIPID (PMID 41156531)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
  sample_size, population_text, duration_text,
...
-- 마그네슘 → ENERGY_METABOLISM (PMID 34836329)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
...
-- 아연 → IMMUNE_FUNCTION (PMID 23775705)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
  sample_size, population_text, duration_text,
...
-- 비타민 B12 → RBC_FORMATION (PMID 39964959)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
  population_text, duration_text,
...
-- 비타민 C → COLLAGEN_SYNTHESIS (PMID 40317316)
INSERT INTO evidence_studies (
  ingredient_id, source_type, title, abstract_text, authors, journal_name,
  publication_year, pmid, doi, external_url, study_design,
  population_text, duration_text,
...
-- 비타민 A → EYE_HEALTH: 기존 PMID 35294044에 야맹증 결과 추가
INSERT INTO evidence_outcomes (
  evidence_study_id, claim_id, outcome_name, outcome_type, effect_direction,
  conclusion_summary, effect_size_text, p_value_text, confidence_interval_text
) VALUES (
...
SELECT 'SUCCESS: 모든 데이터가 적용되었습니다.' AS result,
       ...
       (SELECT count(*) FROM evidence_studies WHERE included_in_summary = true) AS included_studies;
