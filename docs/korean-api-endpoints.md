...
| 식품안전나라 | `I0960` 건강기능식품 기준규격 DB | REST | `http://openapi.foodsafetykorea.go.kr/api/{FOODSAFETY_KOREA_API_KEY}/I0960/json/{start}/{end}` | `FOODSAFETY_KOREA_API_KEY` |
...
| 2026-03-27 | 식품안전나라 `I0960` | 수집 파이프라인 반영 | 기준규격 항목(`PC_KOR_NM`, `MNMM_VAL`, `MXMM_VAL`, `UNIT`) 저장 |
...
- 성분 기준규격(예: 비타민 B6 최소/최대값)은 `I0960`에서 내려오며, `I0030/C003/I0760`만으로는 누락될 수 있다.
