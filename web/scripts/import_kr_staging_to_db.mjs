...
const datasets = [
  ...
  {
    key: "regulatory_standards",
    filePath: path.join(rootDir, "tmp", "kr-gov-clean", "regulatory_standards.normalized.jsonl"),
    tableName: "staging_regulatory_standards_kr",
    conflictColumns: [
      "source_dataset",
      "product_code",
      "test_name_ko",
  ...
  },
  {
    ...
    mapRow(row) {
      return {
        ...
        amount_per_serving: row.amountPerServing,
        amount_unit: row.amountUnit,
        daily_amount: row.dailyAmount,
        daily_amount_unit: row.dailyAmountUnit,
