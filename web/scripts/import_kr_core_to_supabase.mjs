...
function mapProductIngredientRow(row, productId, ingredientId) {
  return {
    ...
    amount_per_serving: row.amountPerServing ?? null,
    amount_unit: row.amountUnit ?? null,
    daily_amount: row.dailyAmount ?? null,
    daily_amount_unit: row.dailyAmountUnit ?? null,
