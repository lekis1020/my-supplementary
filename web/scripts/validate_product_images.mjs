...
분류 기준:
- "product_front": 제품 패키지 전면이 잘 보이는 사진 (흰 배경, 깔끔한 제품 사진)
- "product_angle": 제품이 보이지만 각도가 있거나 여러 제품이 함께 나옴
- "marketing": 마케팅/광고 이미지 (판매누적, 할인가격, 과도한 텍스트, 일러스트, 모델, 배너 스타일)
- "set_gift": 선물세트/묶음 패키지 사진 (여러 제품이 선물 박스에 담긴 이미지)
